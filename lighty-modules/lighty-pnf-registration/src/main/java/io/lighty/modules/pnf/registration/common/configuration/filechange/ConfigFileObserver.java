 ...
 *
 */
package io.lighty.modules.pnf.registration.common.configuration.filechange;
...
import io.lighty.modules.pnf.registration.common.file.FileWatchdog;
...
public class ConfigFileObserver extends FileWatchdog {
    ...
    public ConfigFileObserver(String filename, long pollIntervallMs) {
        super(filename);
