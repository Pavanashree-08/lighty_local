...
* unzip example application bundle ```unzip  lighty-community-pnf-registration-app-23.0.0-SNAPSHOT-bin.zip```
* go to unzipped application directory ```cd lighty-community-pnf-registration-app-23.0.0-SNAPSHOT```
* start controller example controller application ```java -jar lighty-community-pnf-registration-app-23.0.0-SNAPSHOT.jar``` 

### Test example application
Once example application has been started using command ```java -jar lighty-community-pnf-registration-app-23.0.0-SNAPSHOT.jar``` 
...
`java -jar lighty-community-pnf-registration-app-23.0.0-SNAPSHOT.jar /path/to/singleNodeConfig.json`
